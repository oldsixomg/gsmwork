...
#define OS_EVENT_NAME_SIZE       10    /* Determine the size of the name of a Sem, Mutex, Mbox or Q    */
...
#define OS_MAX_TASKS             13    /* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_FLAG_NAME_SIZE        10    /*     Determine the size of the name of an event flag group    */
...
#define OS_TMR_CFG_MAX            3    /*     Maximum number of timers                                 */
