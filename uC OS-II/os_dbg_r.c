...
*/
INT16U  const  OSEventEn           = 0;
INT16U  const  OSEventMax          = 1;             // /Number of event control blocks      
INT16U  const  OSEventNameEn       = 0;
#if (OS_EVENT_EN) && (OS_MAX_EVENTS > 0)
INT16U  const  OSEventSize         = sizeof(OS_EVENT);          // Size in Bytes of OS_EVENT           
INT16U  const  OSEventTblSize      = sizeof(OSEventTbl);        // Size of OSEventTbl[] in bytes       
#else
...
INT16U  const  OSEventTblSize      = 0;
#endif
INT16U  const  OSEventMultiEn      = 1;


INT16U  const  OSFlagEn            = 1;
